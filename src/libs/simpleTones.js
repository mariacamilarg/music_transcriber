// LIBRARY FROM @escottalexander
// https://github.com/escottalexander/simpleTones.js/blob/master/simpleTones.js
...
//Primary function
function playTone (key, type, duration) {
